            ...
            ? (function (t, e, n) {
                return function i(o) {
                  for (var r = t.querySelectorAll(e), s = o.target; s && s !== this; s = s.parentNode)
                    for (var a = r.length; a--; ) if (r[a] === s) return i.oneOff && V.off(t, o.type, n), n.apply(s, [o]);
                  return null;
                };
              })(t, n, i)
            : (function (t, e) {
  ...
  var tt = {
    ...
    at = (function () {
      ...
      return (
        ...
        (n.pause = function (t) {
          t || (this._isPaused = !0),
            et.findOne('.carousel-item-next, .carousel-item-prev', this._element) && (p(this._element), this.cycle(!0)),
          ...
          if (
            ...
            if (
              ...
              s.classList.remove('active'),
                l.classList.add('active'),
                (this._isSliding = !1),
                V.trigger(this._element, 'slid.bs.carousel', { relatedTarget: l, direction: o, from: a, to: c });
            u && this.cycle();
          }
        }),
    ...
    dt = (function () {
      ...
      return (
        ...
        (t.collapseInterface = function (e, n) {
          ...
          if (
            (!i && r.toggle && 'string' == typeof n && /show|hide/.test(n) && (r.toggle = !1), i || (i = new t(e, r)), 'string' == typeof n)
          ) {
      ...
      modifiers: {
              ...
              f = {
                ...
                secondary: function (t) {
                  var n = 'right' === t ? 'left' : 'top',
                    i = u[n];
                  return (
                    u[t] > l[t] && !e.escapeWithReference && (i = Math.min(u[n], l[t] - ('right' === t ? u.width : u.height))), Ht({}, n, i)
                  );
                },
              };
            return (
            ...
            return (
              s.forEach(function (a, l) {
                ...
                var c = t.offsets.popper,
                  ...
                  b =
                    !!e.flipVariations &&
                    ((_ && 'start' === r && d) || (_ && 'end' === r && p) || (!_ && 'start' === r && m) || (!_ && 'end' === r && g)),
                  y =
                    !!e.flipVariationsByContent &&
                    ((_ && 'start' === r && p) || (_ && 'end' === r && d) || (!_ && 'start' === r && g) || (!_ && 'end' === r && m)),
                  w = b || y;
                (h || v || w) &&
                  ((t.flipped = !0),
                  (h || v) && (i = s[l + 1]),
        ...
        inner: {
          ...
          fn: function (t) {
            ...
            return (
              (o[s ? 'left' : 'top'] = r[n] - (a ? o[s ? 'width' : 'height'] : 0)), (t.placement = Gt(e)), (t.offsets.popper = Rt(o)), t
            );
          },
        },
        hide: {
        ...
        computeStyle: {
          ...
          fn: function (t, e) {
            ...
            if (
              ...
              (c[d] = 'translate3d(' + p + 'px, ' + m + 'px, 0)'), (c[f] = 0), (c[h] = 0), (c.willChange = 'transform');
            else {
              var g = 'bottom' === f ? -1 : 1,
                v = 'right' === h ? -1 : 1;
  ...
  var we = 'dropdown',
    ...
    ke = (function () {
      ...
      return (
        ...
        (n._getConfig = function (t) {
          return (
            (t = o(o(o({}, this.constructor.Default), tt.getDataAttributes(this._element)), t)), v(we, t, this.constructor.DefaultType), t
          );
        }),
              ...
              if ((e && 'click' === e.type && (a.clickEvent = e), s)) {
                ...
                if (n[i].classList.contains('show'))
                  if (
                    !(
                      e &&
                      (('click' === e.type && /input|textarea/i.test(e.target.tagName)) || ('keyup' === e.type && 'Tab' === e.key)) &&
                      l.contains(e.target)
                    )
                  )
        ...
        (t.dataApiKeydownHandler = function (e) {
          if (
            ...
            if ('Escape' === e.key)
              return (
                (this.matches('[data-toggle="dropdown"]') ? this : et.prev(this, '[data-toggle="dropdown"]')[0]).focus(),
                void t.clearMenus()
              );
            if (i && 'Space' !== e.key) {
      ...
      return (
        ...
        (n._resetScrollbar = function () {
          ...
          void 0 === t
            ...
            : (tt.removeDataAttribute(document.body, 'padding-right'), (document.body.style.paddingRight = t));
        }),
      ...
      return (
          ...
          if (null !== t)
            return 'object' == typeof e && m(e)
              ...
              : void (this.config.html
                  ? (this.config.sanitize && (e = He(e, this.config.whiteList, this.config.sanitizeFn)), (t.innerHTML = e))
                  : (t.textContent = e));
        }),
        (n.getTitle = function () {
        ...
        (n._setListeners = function () {
          ...
          this.config.trigger.split(' ').forEach(function (e) {
            ...
            this.config.selector ? (this.config = o(o({}, this.config), {}, { trigger: 'manual', selector: '' })) : this._fixTitle();
        }),
        ...
        (n._getConfig = function (t) {
          ...
          return (
            ...
            'number' == typeof (t = o(o(o({}, this.constructor.Default), e), 'object' == typeof t && t ? t : {})).delay &&
      ...
      return (
        ...
        (n._activate = function (t) {
          ...
          n.classList.contains('dropdown-item')
            ? (et.findOne('.dropdown-toggle', n.closest('.dropdown')).classList.add('active'), n.classList.add('active'))
      ...
      (n.show = function () {
        ...
        if (
          ...
          if (
            ...
            !(V.trigger(this._element, 'show.bs.tab', { relatedTarget: e }).defaultPrevented || (null !== r && r.defaultPrevented)))
          ) {
  ...
  var hn = { animation: 'boolean', autohide: 'boolean', delay: 'number' },
    ...
    pn = (function () {
      ...
      return (
        ...
        (n._getConfig = function (t) {
          return (
            (t = o(o(o({}, dn), tt.getDataAttributes(this._element)), 'object' == typeof t && t ? t : {})),
