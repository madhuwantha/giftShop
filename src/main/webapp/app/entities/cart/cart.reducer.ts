...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_CART: 'cart/PARTIAL_UPDATE_CART',
...
export default (state: CartState = initialState, action): CartState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_CART):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_CART):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_CART):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<ICart> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_CART,
