...
class CartResourceIT {
    ...
    public static Cart createEntity(EntityManager em) {
        Cart cart = new Cart().descripption(DEFAULT_DESCRIPPTION);
        return cart;
    }
    ...
    public static Cart createUpdatedEntity(EntityManager em) {
        Cart cart = new Cart().descripption(UPDATED_DESCRIPPTION);
        return cart;
    }
    ...
    void putNewCart() throws Exception {
        ...
        updatedCart.descripption(UPDATED_DESCRIPPTION);
    ...
    void fullUpdateCartWithPatch() throws Exception {
        ...
        partialUpdatedCart.descripption(UPDATED_DESCRIPPTION);
