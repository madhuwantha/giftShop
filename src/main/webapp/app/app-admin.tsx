...
export const AppAdmin = (props: IAppProps) => {
  useEffect(() => {
    props.getSession();
    props.getProfile();
  }, []);

  const paddingTop = props.isAdmin ? '55px' : '0px';
  return (
...
export default connect(mapStateToProps, mapDispatchToProps)(hot(module)(AppAdmin));
