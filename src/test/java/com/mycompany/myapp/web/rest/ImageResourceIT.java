...
class ImageResourceIT {
    ...
    public static Image createEntity(EntityManager em) {
        Image image = new Image().imagepath(DEFAULT_IMAGEPATH);
        return image;
    }
    ...
    public static Image createUpdatedEntity(EntityManager em) {
        Image image = new Image().imagepath(UPDATED_IMAGEPATH);
        return image;
    }
    ...
    void putNewImage() throws Exception {
        ...
        updatedImage.imagepath(UPDATED_IMAGEPATH);
    ...
    void fullUpdateImageWithPatch() throws Exception {
        ...
        partialUpdatedImage.imagepath(UPDATED_IMAGEPATH);
