  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="giftShopApp.category.home.createOrEditLabel" data-cy="CategoryCreateUpdateHeading">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : categoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvField id="category-categoryName" data-cy="categoryName" type="text" name="categoryName" />
              </AvGroup>
