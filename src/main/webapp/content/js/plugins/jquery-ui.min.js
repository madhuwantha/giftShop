            ...
            return (
              ...
              f(o.props, function (t, n) {
                ...
                null !== h &&
                  (null === a
                    ? (l[o] = h)
                    : (c.mod && (h - a > c.mod / 2 ? (a += c.mod) : a - h > c.mod / 2 && (a -= c.mod)), (l[o] = i((h - a) * e + a, n))));
              }),
              this[n](l)
            );
          },
      ...
      for (
        ...
        for (x = '', this.maxRows = 4, C = 0; U[1] > C; C++) {
          ...
          for (
            ...
            for (
              I += '<tr>', E = u ? "<td class='ui-datepicker-week-col'>" + this._get(t, 'calculateWeek')(z) + '</td>' : '', w = 0;
              7 > w;
              w++
            )
          ...
          Z++,
            Z > 11 && ((Z = 0), te++),
            (I +=
              '</tbody></table>' + ($ ? '</div>' + (U[0] > 0 && C === U[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : '') : '')),
            (x += I);
        }
        y += x;
      }
  ...
  var v = (t.ui.intersect = (function () {
    ...
    return function (e, i, s, n) {
      ...
      switch (s) {
        ...
        case 'touch':
          return (
            ((a >= c && d >= a) || (l >= c && d >= l) || (c > a && l > d)) && ((o >= h && u >= o) || (r >= h && u >= r) || (h > o && r > u))
          );
        default:
          return !1;
      }
          ...
          if (1 === this.containers.length)
            ...
            for (
              ...
              t.contains(this.containers[p].element[0], this.items[s].item[0]) &&
                ...
                n > Math.abs(e[u] - l) && ((n = Math.abs(e[u] - l)), (o = this.items[s]), (this.direction = h ? 'up' : 'down')));
