        ...
        Optional<Client> result = clientRepository
            ...
            .map(
                existingClient -> {
                    ...
                    if (client.getAddressLineOne() != null) {
                        existingClient.setAddressLineOne(client.getAddressLineOne());
                    }
                    if (client.getAddressLineTwo() != null) {
                        existingClient.setAddressLineTwo(client.getAddressLineTwo());
                    }
