        ...
        Optional<Employee> result = employeeRepository
            ...
            .map(
                existingEmployee -> {
                    ...
                    if (employee.getBasicSallary() != null) {
                        existingEmployee.setBasicSallary(employee.getBasicSallary());
                    }
                    if (employee.getEmploymentDate() != null) {
                        existingEmployee.setEmploymentDate(employee.getEmploymentDate());
                    }
                    if (employee.getNumberOfDependants() != null) {
                        existingEmployee.setNumberOfDependants(employee.getNumberOfDependants());
                    }
